...
The entire country is bisected by a well-maintained paved road, permitting relatively easy access to habitats from 150m to 3,750m. One of the important features of Bhutan is that birding, especially in mid to late spring (late March to mid-May) is good virtually everywhere. Unlike many parts of Asia, one is not obliged to seek out a park or reserve or remnant patch of ‘good looking’ habitat, since any stop, even in the midst farmland, exciting birds are visible.
...
Facts and Figures
Land area : 38,394 square kilometers 2
Forest area : 72.5 %
...
const bhutanBirdingExcerpt1 =
  "Nestling in the heart of the Himalayas and protected by a complex geography of high mountains and deep valleys, Bhutan is rated as one of the ‘top ten global hot spots’ of the world. The intriguing yet profound tale of the transformation of this traditional kingdom, without losing out on its traditional norms and values while embarking on a modern course of development in the last half a century has been both a story of sustainable and progressive development in harmony with its natural environment.";

const bhutanBirdingExcerpt2 =
  "Bhutan’s forests cover about 70% of the land, including shrub forest. An estimated 770 species of birds inhabit the unspoiled forests.";
...
export const bhutanItineraries = [
    {
      ...
      title: "The Himalayan Wonderland",
      duration: "5 Days",
      type: "Cultural & Heritage",
      highlights: ["Paro", "Thimphu", "Punakha", "Wangduephodrang"],
      overview:
        "The Land of Peaceful Dragon. This scenic Journey takes you through History, Culture and Lifestyle of Himalayan Kingdom and it's people. As you drive through this scenic country you encounter with simple and happy smiling faces, their enriched culture, handicrafts, Monasteries and the fortress, where time seems to be stand still.",
      images: [
        "/Paro.webp",
        "/Heritage Museum.jpg",
        "/Trashichhodzong.jpg"
      ],
      details: `Day 01: Arrive Paro by Druk Air
...
After breakfast drive to the airport for flight to onward destination.`,
    },
    {
      ...
      duration: "8 Days",
      type: "Culture Tour",
      highlights: ["Paro", "Thimphu", "Trongsa", "Bumthang", "Punakha"],
      overview:
        "Culture Tour of Bhutan. This Journey takes you to Cultural tour of mystical western valleys of the Dragon Kingdom. You will experience the Bhutanese hospitality and rich Buddhist Culture. You will pass through Dochula Pass with spectacular Himalayan views and to the sub tropical Punakha valley.",
      images: [
        "/Trongsa.jpg",
        "/Bumthang.jpg",
        "/Punakha.jpg"
...
Proceed to Tongsa across Pelela pass (3,300 m), the traditional boundary between east and west. The pass is marked by a large prayer flag and the ground is covered with high altitude dwarf bamboo.

Stop enroute at Chendbji Chorten, which was built in 18th century by a Lama named Shida, it is Nepalese in style with eyes painted at four cardinal points.
...
Today's full day sightseeing in Paro valley includes, visit to Ta Dzong, the National Museum which in the past served as watch tower for the Paro Dzong, the Paro Dzong (Rinpung Dzong) built in 1646 by Shabdrung Ngawang Namgyal.
...
After breakfast drive to the airport for flight to onward destination.`,
    ...
    {
      id: "nepal-bhutan-tour",
      title: "Nepal & Bhutan Tour",
      duration: "12 Days",
      type: "Multi-Country",
      highlights: ["Kathmandu", "Paro", "Thimphu", "Punakha", "Kolkata"],
      overview:
        "A Journey to Himalayan Kingdoms. This Journey takes you through a cultural extravaganza of Two Himalayan Kingdoms, Nepal & Bhutan. Nepal, where the founder of Buddhism, the Lord Buddha was born & which is home to the eight highest mountains in the world & the highest point on earth, the Mount Everest at 8,848 meters.",
      images: [
        "/Thimphu.webp",
        "/Punakha.jpg",
        "/Himalayan peaks..png"
      ],
      details: `Day 01: Arrive Kathmandu

WELCOME TO NEPAL: Surrounded by a tier of green mountain wall above which tower mighty snow capped peaks, the Kathmandu Valley has an exotic setting. It is very rich in history art and culture apart from being known as the abode of the Gods.

You will be met by our representative holding a paging board with your name on it outside the customs and immigration area and transfer to hotel
...
After breakfast proceed for a sight seeing tour of Patan City, Bugmati and Khokana Newari Village.

PATAN DURBAR SQUARE: Patan also have the Royal Palace facing the Durbar Square but Patan's Durbar Square is a concentrated mass of temples, undoubtedly the most visually stunning display of Newari architecture to be seen in Nepal. This square rose to its full glory during the Malla Period. After the visit of Durbar Square, we will go inside the city where the public stays inside the Patan City on their traditional way.

After Lunch drive to Bugmati and Khokana Typical Newari Village, The 13th century old Newar settlement of Khokana is famous for producing mustard oil. There is no central square, as in near by village Bungamati but there's plenty of action in the main street, including women spinning wool. The main temple is a two tiered construction dedicated to Shekali Mai – a mother goddess.
...
After breakfast proceed for a sight seeing tour of Kathmandu City and Pashupati Nath Temple

Kathmandu Durbar Square: complex of palaces, courtyards, and temples were built in the 12th to 18th centuries used to be the seat of the ancient Malla kings of Kathmandu. An intriguing piece here is the 17th century stone inscription set in to the wall of the palace with writing in 15 languages.

After lunch proceed for Pashupati Nath Temple visit, Pashupatinath is the holiest Hindu pilgrimage destination in Nepal. There are linga images of Shiva along with statues, shrines, and temples dedicated to other deities in the complex.

OVERNIGHT AT THE HOTEL.

Day 04: Kathmandu

Early Morning drive to the airport to take an hour Flight to view spectacular mountain scenery. The Everest flight is a sparkling clear journey across the world's highest peaks, Mt. Everest - world's highest peak (8848 m) and other ranges of Himalayas.

After Breakfast Proceed for the Sight seeing tour of Bhakatpur City and Thimi Village.

Bhaktapur City: known as the 'City of Devotees' is renowned around the world for its art and architecture. It is a city steeped in culture. The city was founded by King Anand Dev Malla in the 12th century and is found 8miles from Kathmandu, the Nepalese capital city.

After lunch proceed for the Thimi Village, Thimi is well-known for earthen wares (terra-cotta/ceramics), masks, puppets, traditional hand woven clothes and other handicrafts.

OVERNIGHT AT THE HOTEL.

Day 05: Kathmandu-Paro/ Transfer to Thimphu

Breakfast at the hotel.

Transfer from hotel to the airport in time for flight to Paro and transfer to Thimphu. (1.5 hours drive).

After lunch you will have the choice to visit the National Memorial Chorten, National Textile Museum, Folk Heritage Museum, and National Library with time to stroll the main street for some interesting Himalayan artefacts or textiles. Overnight at Hotel.

Day 06: Tour of Thimphu

This morning you will visit the north end of the valley to view Trashi Chhoe Dzong, the seat of Bhutan's government and Royal offices, and Pangri Zampa, two 16th century buildings that now house a monastic training school for astrologers. At the head of the valley, should you wish to stretch your legs, a short hike will take you to Cheri Goemba, the monastery where the first monastic body was established in the Kingdom. Back in town, you will be able to visit a few of the capital's cottage industries ranging from traditional paper making to hand-rolled incense. Overnight at Hotel.

Day 07: Thimphu

Full day at leisure

Optional: Full day trip to Punakha.

This morning, your day will begin with a hike up through rice fields along the banks of the Mo Chhu to the upper end of the valley to the Khamsum Yuelley Namgyal Chorten, a stunning monument recently built by the Queens and consecrated in 1999. Following the hike you will drive back up the valley towards Khuruthang passing Punthsho Pelri Palace and several other winter homes of the royal family. Following lunch, visit the impressive Punakha Dzong. This ancient fortress is the winter residence of the monastic order's head and still serves as the administrative headquarters for the Punakha region. Then visit the Chimi Lhakhang, the auspicious fertility monastery built in 1499 and a temple dedicated to the "Divine Madman", an eccentric monk from the 16th century famous for many his many amusing, Rabelaisian folklore stories. Overnight at Hotel.

Day 08: Transfer to Paro

The final leg of your journey takes you back to Paro Valley which is 1.5 hour drive from Thimphu. A few steps at the end of a village road lead you through a pine forest. Across a small brook, the carpet of pine needles leads to a clearing and the cluster of buildings that house Amankora Paro, a 24-suite lodge. Paro Valley sits on an elevation of 2,250 metres (7,382 feet). Amankora Paro and its spa, set inside a forest of pine. The spa offers a range of unique healing and rejuvenating treatments.

There is an opportunity for a quick stroll to the nearby ruins, a visit to some of the valley's oldest and holiest religious monuments or a ramble down Paro's main street. (overnight: Amankora in Paro)

Paro Tsechu, today is the first day of the Tsechu which ends about 3.30pm Religious festivals known as 'Tsechus' and 'Dromchoes' symbolizing amity, peace and compassion, are held annually at various parts of the kingdom at different times of the year.

Overnight at Hotel.

Day 09: Paro Valley Exploration

After breakfast walk to the ground above the Dzong and witness the festival. Today, the festival will be held outside the dzong in the open air and you will get much better view of the festival from the slopes and you will get to interact more with the local people. The festival will last till 3 PM. A visit to the Kyichu Lhakhang is one of the oldest and most sacred temples in the Kingdom, dating back to the 7th century when the seed of Buddhism was won in Bhutan.

Overnight at Hotel.

Day 10: Hike to Taktsang Gomba

Start an early morning hike up to view one of Bhutan's most revered monuments, the Taktsang Gompa, more commonly referred to as the "Tiger's Nest". The four-hour trek offers spectacular views of this sacred monastery perched on a cliff face 900m above the valley floor. In the afternoon, you could pay a visit to the National Museum, housed in the Ta Dzong (watchtower). Here, an intriguing collection of artefacts provide a wonderful introduction to the rich culture and heritage of the Kingdom. Just a short walk downhill lies the dominating Paro Dzong, a fine example of Bhutanese historic architecture.
...
Kolkata (Calcutta) – The capital of West Bengal, is situated along the banks of the Hooghly river. Calcutta's, 300 years history traces to the landing of Robert Clive on the banks of the Hooghly.

Afternoon, proceed for a sightseeing tour of Kolkata. The Tour begins from the Victoria Memorial, the best introduction to that era, foundation laid in 1906 by The Prince of Wales (later King George V) and opened in 1921 by the Duke of Windsor. Visit the Indian museum (closed on Mondays), built in 1875, its certainly the largest and probably the best museum in India and one of the best in Asia, displaying priceless relics of ancient civilizations.

Overnight at the hotel.

Day 12: Kolkata Depart

Breakfast at the hotel. Later transfer to Airport for onward Journey.`,
    },
    {
      id: "east-india-bhutan",
      title: "East India & Bhutan",
      duration: "13 Days",
      type: "Multi-Region",
      highlights: ["Delhi", "Darjeeling", "Gangtok", "Thimphu", "Bumthang", "Paro"],
      overview:
        "A journey to Eastern Himalayas. This journey takes you through the Eastern region of mighty Himalayas, Darjeeling and Sikkim and drive through the Hidden Kingdom of Bhutan. The eastern State of India will give you Breath taking view of Mt. Kanchenjunga, a joy ride of Toy train of British Era.",
      images: [
        "/Delhi.jpeg",
        "/Darjeeling.webp",
        "/Gangtok.jpeg"
...
Arrive early morning at New Delhi International airport. On arrival at International airport, the guest will be met by our representative and transferred to hotel. Overnight at hotel.

Day 02: Delhi - Bagdogra - Darjeeling

Morning transfer to the airport for flight to Bagdogra Upon arrival at Bagdogra, the guests will be proceed straight to Darjeeling (80 kms). On arrival at Darjeeling – check into hotel Darjeeling - At an altitude of 2134m facing the Himalayas dominated by Mt. Kanchenjunga, Darjeeling was the summer resort of the British after they acquired it in 1835. Manor houses, bungalows & cottages sprung up and English-style gardens flowered everywhere. The first tea plantations appeared in 1840 & they thrived in the perfect climate. By 1881, when a narrow - gauge "Toy Train" was commissioned, the hill station of Darjeeling was completely anglicized. Afternoon enjoy a leisurely walk on the principal boulevard - "The Mall" in the center of town lined by small souvenir shops, cafes and tea stalls. The mall leads to the square called "Chaurastha" where there is a music and bookshop selling antique books & magazines on India & Tibet. Thereafter visit the Observatory Hill which is perhaps oldest part of the city. This is the location of a former Buddhist monastery of the Red Hat Sect called Dorje Ling, which was destroyed by the Nepalese gurkhas in the 19th century. Overnight at hotel.

Day 03: Darjeeling

Excursion to Tiger Hill (10 kms south of Darjeeling) for a sunrise view of Mt. Kanchenjunga. On a clear day the entire chain is visible, with the 'Kanchenjunga' in the center and the 'Kabru' and the 'Pandim' peaks on either side. To the right are the "3 sisters" - Everest, Makalu and Lhotse. To the east, in the distance are the Tibetan peaks. Morning transfer to the Railway Station for Toy Train journey to Ghoom The Darjeeling Himalayan Railway is lovingly called the "Toy Train". The Toy Train ride is a romantic approach to the Himalayas, a mysterious region. The landscape can only be described as spectacular and the views of the Himalayan peaks breathtaking. Afternoon at leisure for own activities. Overnight at hotel.

Day 04: Darjeeling - Gangtok

Morning drive to Gangtok (180 kms). The route passes through beautiful hills covered with tea plantations around Darjeeling, before plunging towards the Tista river and then up along the river to Gangtok. Spread over one side of a hill, Gangtok, the capital of Sikkim, directly faces the Kanchenjunga mountain range. Upon arrival in Gangtok – check into hotel Afternoon drive out to Rumtek Monastery the seat of the gyalway Karmapa, head of the Kagyapa seat of Buddhism and built by him when he took refuge in Sikkim. It houses some of the world's most unique artefacts, ancient manuscripts and icons. Visit the Institute of Tibetology with its superb "Thankas" and also the "Orchid Sanctuary" which is a botanical garden offering 500 varieties of Orchids. Overnight at hotel.

Day 05: Gangtok - Phuentsholing

After breakfast our drive today takes us through ever-changing landscapes of scenic splendor as we make our way toward the little town of Phuntsoling, gateway to the Samchi district in the Dragon Kingdom, Bhutan (230 kms). Upon arrival, check-in at Hotel. Phuentsholing is a fascinating mixture of intermingling of Bhutanese, Indian, Nepalese culture. Evening take a stroll around Phuentsholing town and visit Zangtho Pelri Lhakhang, the temple situated in city centre. It represents the heaven of Guru Rinpoche. Overnight at the hotel.

Day 06: Phuentsholing - Thimphu

After breakfast drive to Thimphu (179 kms), the modern capital town of Bhutan. This drive is very pleasant with numerous scenic spots en route 4 km ahead of Phuentsholing, visit to Kharbandi Gompa, the beautiful monastery situated in garden of tropical plants and flowers, built in 1967 by Royal Grand mother. Further ahead, visit Kamji monastery. Arrive Thimphu in the afternoon and check into the hotel. Evening at leisure. Overnight at hotel.

Day 07: Thimphu

Full day sightseeing of Thimphu Valley which includes visit to the National Liberary which holds a vast collection of ancient Buddhist texts and manuscripts, Painting school famous for it's traditional thangkha paintings, Traditional Medicine Institute famous for it's Herbal medicines. Also visit the Memorial Chorten, the beautiful stupa built in the memory of Bhutan's third king and Tashichhodzong, the beautiful fortress/monastery. Overnight at hotel.

Day 08: Thimphu - Tongsa

After early breakfast, drive to Tongsa (200 kms) via Dochula pass (3,050m). From this pass, if the weather permits, you can see a range of high Himalayan peaks towards the north east. Further drive onwards arriving Wangdiphodrang town for lunch. The descent from Dochula into Wangdiphodrang valley is quite long as the altitude difference is 1700 meters. Proceed to Tongsa across Pelela pass (3,300 m), the traditional boundry between east and west. The pass is marked by a large prayer flag and the ground is covered with high altitude dwarf bamboo. Stop enroute at Chendbji Chorten, which was built in 18th century by a Lama named Shida, it is Nepalese in style with eyes painted at four cardinal points. Arrive Tongsa and check into the lodge. Overnight at lodge.

Day 09: Tongsa - Bumthang

After breakfast walk by Tongsa Dzong built by Shabdrung in 1647 and visit the Ta Dzong (watch tower), dedicated to Buddhist epic hero, King Gesar of ling. Then drive to Bumthang (68 Kms). 29 kms ahead of Tongsa, you would reach the yutong La pass and further ahead the road enters into a wide cultivated valley known as Chumey valley. On arrival in Bumthang, check-into the lodge. Afternoon visit Kurje Lhakhang where the saint Padsambhava subdued a local demon and left his body imprint in a rock, The Jambey Lhakhang (7th century temple), Tamshing Monestery, the jakar Dzong and Swiss Farm House. Overnight at lodge.

Day 10: Bumthang - Punaka

After Breakfast drive to Punakha (125 kms) en route visiting 17th century majestic Wangdi Dzong followed by visit to local market. the district of Wangdiphodrang is also famous for its bamboo products, slate and stone carvings. Evening visit Punakha Dzong, a massive structure built at the junction of two rivers. It was the capital of Bhutan until 1955, and still serves as the winter residence of the monk body. The first King, Ugyen Wangchuck was crowned here in 1907. The fortress has withstood several damages from fire, earthquake and flood. Overnight at Hotel.

Day 11: Punaka - Paro

After breakfast drive to Paro (125 kms). Sightseeing in Paro valley includes, visit to Ta Dzong, the National Museum which in the past served as watchtower for the Paro Dzong. Then walk down the trail to visit Paro Dzong (Rinpung zong) built in 1646 by Shabdrung Ngawang Namgyal, it has a long and fascinating history. Evening drive to Drukgeyl Dzong, built in 1647 by the Shabdrung to ommemorate Bhutanese victory over the Tibetans in war of 1644. Also en route visit Kyichu Lhakhang, one the oldest and most sacred shrines of the Kingdom. Overnight at the hotel.

Day 12: Paro - Delhi

After breakfast, transfer to the airport for flight to Delhi. Upon arrival transfer to the hotel for an overnight. Later transfer to the international airport for flight back to home.
...
In time transfer to airport to board flight for abroad.`,
    },
    {
      ...
      duration: "11 Days",
      type: "Birding",
      highlights: ["Paro", "Thimphu", "Gangtey", "Punakha", "Chele La"],
      overview:
        bhutanBirdingExcerpt1,
      images: [
        "/Bhutan/Bhutan%20Birding1.jpg",
        "/Bhutan/bhutan%20birding.jpg",
        "/Bhutan/bhutan%20birdingg.jpg"
      ],
      details: `${bhutanBirdingCommonIntro}

DAY 01 : ARRIVE PARO BY AIR & TRANSFER TO THIMPHU
The flight to Paro is one of the most spectacular in entire Himalayas. Whether flying along the Himalayan range from Kathmandu or over the foothills from Kolkatta, the journey offers fascinating views and an exciting descent into the Kingdom. Bhutan’s first gift as you disembark from the aircraft will be cool, clean fresh mountain air.
After immigration formalities and baggage collection, you will be met by our representative, and afterwards drive to Thimphu, the modern capital town of Bhutan. Later explore this beautiful upland valley. Relatively dry, the Thimphu valley is surrounded by fine stands of Blue Pine and temperate evergreen forests. The increasing human settlement has pushed birding spots at least 10 kilometers further and now the ideal areas for birding are around the stream near Motithang and in and around Begana and Cheri villages.
Depending on the fight timing , we will spend rest of the day birding around , some of the bird species in Thimphu include : Blyth’s leaf Warbler, Black earned Kite, Blue whistling Thrush, Brown Parrotbil, Common Myna, Common Sandpiper, Common Kestrel, Eurasian Hobby, Fire tailed Sunbird, Greater short toed LarkGolden spectacled Warbler, Grey backed Shrike, Hodgson’s Redstart, Laughing Thrush, Long tailed Minivet, Oriental Skylark, Oriental turtle Dove, Oriental white eye, Red rumped Swallow Rufous Sibia, Ruddy breasted Crake, Spotted throated Yuhina, White browned Fulvetta, White capped Redstart, Yellow breasted Greenfinch, Brown Dipper, Black Eagle, Blyth’s Pipit Black browed Tit, Coal Tit, Common Buzzard, Eurasian Hoopoe, Eurasian sparrow Hawk, Grey bush Chat, Grey Wagtail, Grey sided Bush Warbler, House Crow, Large billed Crow Leomn rumped Warbler, Mountain hawk Eagle, Oriental honey Buzzard, Olive backed pipit, Plumbeous water Redstart, Rusty flanked Treecreeper, Red billed Chough, Rock Pigeon , Spotted laughing Thrush, Tickell’s leaf Warbler, Whiskered Yuhina, White throated laughing Thrush
Time permitting again , we will visit some of Thimphu’s cultural sites like Trashichhodzong (This impressive fortress/monastery houses Secretariat building, the throne room of His Majesty, the King and various government offices. It is also the summer residence of Chief Abbot and central monk body) , and Memorial Chorten : The building of this landmark was envisaged by the third king, His Majesty Jigme Dorji Wangchuck, as a monument to world peace and prosperity. Completed in 1974 after his untimely death, it is both a memorial to the Late King (“the Father of modern Bhutan”) and a monument to world peace. The paintings and statues inside the monument provide a deep insight into Buddhist philosophy.
Overnight at the hotel in Thimphu. (Altitude 2400m).

DAY 02 : THIMPHU
National Parks in Bhutan are not developed into a Tourist Destination , nor are there any wildlife options .
However, the following can be done on the second day in Thimphu :
After breakfast in the morning excursion to Tango Gompa : This monastery was founded by Lama Gyalwa Lhanangpa in the 12th century and the present building was built in the 15th century by the ‘Divine Madman’, Lama Drukpa Kunley. In 1616 Shabdrung Ngawang Namgyal visited Tango and meditated in a cave near the monastery. His meditation helped ensure the defeat of an invading Tibetan army. The head Lama, a descendent of Lama Drukpa Kunley presented the goemba to Shabdrung, who carved a sandalwood statue of Chenrezig which he installed in the monastery. The picturesque three-storey tower and several surrounding buildings were built in the 18th century by the eighth Desi, Druk Rabgye and Shabdrung Jigme Chhogyel added the golden roof in the 19th century. Situated north of Thimphu, one way it takes about 30 minutes drive and one hour walk through shaded rhododendron forests to reach the monastery.
Picnic Lunch .
After lunch stroll around a part of the Jigme Dorgi National Park .
Kingdom of Bhutan established its national park system to protect important ecosystems, and they have not been developed as tourist attraction. In many case people even won’t be aware that they are entering or leaving a national park or wild life sanctuary.
...
Later in the afternoon return back to the Hotel.
Dinner and Overnight at the hotel in Thimphu (Altitude 2400m).

DAY 03 : THIMPHU – GANGTEY (150 KM,5+ HRS)
Early morning embark on a Bird watching tour of Thimphu valley. Relatively dry, the Thimphu val ley is surrounded by fine stands of Blue Pine and temperate evergreen forests. The increasing human settlement has pushed birding spots at least 10 kilometers further and now the ideal areas for birding are around the stream near Motithang and in and around Begana and Cheri villages.
...
Then drive to Gangtey across Dochula pass (3,088m) which offers most spectacular view over high peaks of eastern Himalayas.
After lunch stop en route, continue journey eastwards through Black Mountains region. The drive is relatively shorter and there are regular stops for birding and photography along the way. The road finally enters to forest of oak and rhododendron and then broad Phobjikha valley which is one of the few glacial valleys in Bhutan.
...
We will check forest edges and explore some of the small patches of cultivation then continue our search in areas of productive forest near the end of our journey; here we will be looking for species such as: Blood Pheasant, Satyr Tragopan and the majestic Himalayan Monal. Past highlights at this location have included Himalayan Honeyguide, Crested Kingfisher, Tibetan Serin, Short-billed Minivet and Rufous-bellied Bush-robin. Spotted Laughingthrush, Yellowish-bellied Bush-Warbler, Rusty-flanked Treecreeper, White-browed Bush Robin and White-winged Grosbeak
Afternoon visit the Gangtey Goempa: Perched on a small hill that rises from the valley floor, the Gangtey Monastery is the only Nyingmapa monastery on the western side of the Black Mountain’s and also the biggest Nyingmapa monastery in Bhutan. The Monastery is surrounded by a large village inhabited mainly by the families of the 140 Gomchens who take care of the Monastery.
...
Evening exploratory walk on the market streets of Paro. Overnight at the hotel in Paro.

DAY 09 :PARO - TIGER’S NEST HIKE
After breakfast, drive to newly restored Drukgyal Dzong: It was here that the Bhutanese finally defeated the invading Tibetans and drove them back. Peak of Jumolhari ‘Mountain of the Goddess’ can be seen on a clear day from here (7,329 mts/24,029 ft.).
...
Later, we will enjoy an excursion to Taktsang Monastery (Tiger’s Nest), one of the holiest monasteries in Bhutan, which was burnt down in 1988 but is now fully restored. Birds that can be seen in the valley here include Blue Whistling Thrush, Hodgson’s and Blue-fronted Redstart, Hoopoe, Rufous Sibia, White-collared Blackbird, Rufous-breasted Accentor, Long-tailed and Grey-backed Shrikes, and Yellow-billed Blue Magpie.
Taktsang, the ‘Tiger’s Nest’ Monastery, appears to cling magically to the sheer rock face 915 metres above the valley. Legend has it that the Guru Padmasambhava, riding a flying tiger, landed on the cliff when he came from Tibet in the 8th century. There he, and later his follower Dubthok Singye, meditated in a cave around which, 300 years ago, the monastery was built to celebrate his arrival. We will take our time here and are likely to spend most of the time in this wonderful setting and its surrounding forests. On our way up, we will make regular birding stops while enjoying the scenery.
Overnight at the hotel in Paro. (Altitude 2,280m)

DAY 10 : PARO/CHELALA PASS FOR BIRDING:
(One way- 45 kms, approx 1 hr drive)
We will set off after early breakfast for the long drive up to the impressive Chele La pass on the road to Haa, which at a breathtaking 3,780 metres is an excellent spot for seeing the spectacular Himalayan Monal. This must be one of the most colourful and strikingly patterned of all the world’s many pheasants. We hope to see the adult male at relatively close range as it shows off its iridescent blue, indigo, green and black plumage. It is an extraordinary experience to see one flying off, displaying its white back patch, and uttering its wild, ringing cry, and is a spectacle that seems to epitomise high Himalayan birding.
Typical species here include Eurasian Sparrowhawk, Grey Nightjar, Yellow-billed Blue Magpie, Spotted (or Eurasian) Nutcracker, Long-tailed Minivet, Coal, Grey-crested and Rufous-fronted Tits, Black-faced Laughingthrush, White-browed Fulvetta, Rufous-vented Yuhina, Rufous-gorgeted Flycatcher, Buff-barred Warbler, Red-flanked Bluetail, Blue-fronted Redstart, Long-tailed Thrush, White-collared Blackbird, Mrs Gould’s Sunbird, Oliver-backed Pipit, the huge Collared Grosbeak, White-winged Grosbeak, and White-browed and Dark-rumped Rosefinches. With a bit of luck, we will find some Altai Accentors lingering in their winter quarters.
From Chele La we will travel by road for a couple of hours back to Paro, with some birding stops en route.
Then it will be time for a well-deserved rest!
PS: Lunch will be packed lunch today.
...
After an early breakfast at the hotel, drive to the airport for the flight to your onward destination. Our representative will help you with exit formalities and then bid you farewell.`,
    ...
    {
      id: "bhutan-birding-tour-2",
      title: "Bhutan Birding Tour - 2",
      duration: "11 Days",
      type: "Birding",
      highlights: ["Paro", "Thimphu", "Tsirang", "Manas", "Tingtibi", "Phobjikha", "Punakha"],
      overview:
        bhutanBirdingExcerpt2,
      images: [
        "/Bhutan/Bhutan%20Birding1.jpg",
        "/Bhutan/bhutan%20birding.jpg",
        "/Bhutan/bhutan%20birdingg.jpg"
...
Departure from the Kingdom of Bhutan`,
    ...
    {
      id: "bhutan-birding-tour-3",
      title: "Bhutan Birding Tour - 3",
      duration: "10 Days",
      type: "Birding",
      highlights: ["Paro", "Thimpu", "Gangtey", "Bumthang", "Sengor", "Yongkhola", "Trashigang"],
      overview:
        bhutanBirdingExcerpt3,
      images: [
        "/Bhutan/Bhutan%20Birding1.jpg",
        "/Bhutan/bhutan%20birding.jpg",
        "/Bhutan/bhutan%20birdingg.jpg"
...
DAY 1: ARRIVE PARO
Upon arrival meet & greet at Paro Airport, then transfer to your hotel. Later Birding around Paro. Birds we may encounter include Ibisbill, River Lapwing, Grey-backed Shrike, Oriental Turtle Dove, Rufous-breasted Accentor, Hodgson’s Redstart and perhaps Black-tailed Crake. Sightseeing in Paro. Overnight at Hotel.
DAY 2: PARO- THIMPU (1.5 HRS)
...
DAY 4: GANGTEY-BUMTHANG (5.5 HRS)
...
DAY 7: SENGOR-YONGKHOLA (1.5 HRS)
...
DAY 8: YONGKHOLA-TRASHIGANG (5 HRS)
...
Depart at noon for Guwahati, India.
*****END OF THE TOUR******`,
    },
    {
      id: "best-of-bhutan",
      ...
      duration: "8 Days",
      type: "Culture",
      highlights: ["Paro", "Thimphu", "Punakha", "Ta Dzong", "Rinpung Dzong", "Tiger's Nest", "Dochula Pass"],
      overview:
        "A curated journey through the best of the Dragon Kingdom. Experience Bhutan's finest cultural sites, from Paro and Thimphu to Punakha, with dzongs, monasteries, and Himalayan vistas. This itinerary showcases the essence of Bhutanese heritage and landscape.",
      images: [
        "/Paro.webp",
        "/Trashichhodzong.jpg",
        "/Punakha.jpg"
      ],
      details: `Best of Bhutan – Culture itinerary.

Day 01: Arrive Paro and drive to Thimpu

Upon arrival proceed to Thimpu. Ta Dzong (Sun, Mon Govt holiday closed): once a watchtower, built to defend Rinpung Dzong during inter-valley wars of the 17th century, Ta Dzong was inaugurated as Bhutan's National Museum in 1968. It holds fascinating collection of art, relics, religious thangkha paintings and Bhutan's exquisite postage stamps. The museum circular shape augments its varied collection displayed over several floors. Afterwards, walk down a hillside trail to visit Rinpung Dzong, which has a long and fascinating history. Built in 1646 by Shabdrung Ngawang Namgyal, the first spiritual and temporal ruler of Bhutan, the Dzong houses the monastic body of Paro, the office of the Dzongda (district administrative head) and Thrimpon (judge) of Paro district. The approach to the Dzong is through a traditional covered bridge called Nemi Zam. A walk through the bridge, over a stone inlaid path, offers a good view of the architectural wonder of the Dzong as well as life around it. It is also the venue of Paro Tshechu, held once a year in the spring. Drukgyel Dzong: Drukgyal Dzong ruins is located 14kms north of Paro town, near the end of the paved road. Drukgyal Dzong (victories fortress) was built around 1644-49 to commemorate the Bhutanese victory over the Tibetan-Mongol forces. It was later burnt in fire accident in 1951. On a clear day, Mt. Jumolhari, Bhutan's holy peak is seen against its backdrop.

Overnight Thimpu.

Day 02: Thimpu

Breakfast at hotel, the flight into Bhutan takes you over the great Himalayas, offering the scintillating scenery of the world's highest glacial peaks. Morning Visit Takin Sanctuary. Afternoon visit National Memorial Chorten: The building of this landmark was envisaged by the third king, His Majesty Jigme Dorji Wangchuck, as a monument to world peace and prosperity. Completed in 1974 after his untimely death, it is both a memorial to the Late King ("the Father of modern Bhutan") and a monument to world peace. The paintings and statues inside the monument provide a deep insight into Buddhist philosophy.

Overnight at hotel.

Day 03: Thimpu

In the morning you will visit the Late King's Memorial Chorten, the National Library, the indigenous hospital specializing in herbal medicine, handmade paper factory, and the nunnery at Zilukha. In the afternoon, tour of the school of fine arts where young students learn the traditional arts and crafts (Zo Rig Chusum – the thirteen crafts); Zangtopelri Lhakhang, the Handicraft Emporium and the local handicraft centers to see the varieties of textiles, thangkha paintings, masks, Jewellery etc. on display. Buddha Point (Kuensel Phodrang) Located at a short drive from Thimphu city centre, visitors can get a good overview of the Thimphu valley from the Buddha point (Kuensel Phodrang). You can pay your obeisance and offer prayers to the Buddha, the largest statue in the country and then walk around and take a glimpse of the valley.

Overnight at hotel.

Day 04: Thimphu – Punakha (03 hours)

In the morning we drive to Wangdi via Punakha (3 hrs. drive), the old winter capital. Leaving Thimphu the road climbs via a series of zigzags over the Dochu La Pass, 10,000ft/3,048m. On a clear day panoramic views can be had of the eastern Himalaya, including Bhutan's highest mountain, Gangkar Punsum, 24,770ft/7,550m. The road drops down through varied forest finally emerging into the highly-cultivated Punakha valley. Visit Punakha Dzong & optional hike to Chimi Lhakhang, the divine mad monk's temple. It is a beautiful walk through a lovely village. The temple can be visited and there is a tree outside which is supposed to have sprouted up after Drukpa Kunley sent a thunderbolt from an adjoining valley to kill some evil spirits who had gathered at the site.

Overnight Punakha.

Day 05: Punakha – Paro (04 hours)

Breakfast at hotel & drive back to Paro via Dochula & Thimpu. As you enter Paro valley, you will see the silvery Pa Chu (Paro River) meandering down the valley, the Paro Dzong (fortress) and Ta Dzong (watch tower). There are a good many things to see in the capital which has a very relaxed, laid-back feel about it. In the afternoon visit Dzong. Ta Dzong (Sun, Mon Govt holiday closed): once a watchtower, built to defend Rinpung Dzong during inter-valley wars of the 17th century, Ta Dzong was inaugurated as Bhutan's National Museum in 1968. It holds fascinating collection of art, relics, religious thangkha paintings and Bhutan's exquisite postage stamps. The museum circular shape augments its varied collection displayed over several floors.

Overnight at hotel.

Day 06: Paro

Kichu Lhakhang: Kyichu is one of the oldest temples in Bhutan built in the 7th century by Tibetan King Songtsen Gampo. The story goes that a giant demoness lay across Tibet and the Himalayas, which was preventing the spread of Buddhism. To overcome her, King Songtsen Gampo decided to build 108 temples in a single day to pin the ogress to the earth forever in 659AD. Of these 108 temples, 12 were built in accordance with precise plans at key points. The temple of Jokhang in Lhasa was built over the very heart of the demoness and Kichu is said to have been built on the left foot. Dungtshe Lhakhang: Dungtse Lhakhang was constructed by the great bridge-builder Thangtong Gyelpo in 1433. It is said to have been built on the head of demoness, who was causing illness to the inhabitants. The building was restored in 1841 and is a unique repository of Kagyu lineage arts. You may or may not be permitted inside but can walk around this three-storey Chorten-type building. Drukgyel Dzong: Drukgyal Dzong ruins is located 14kms north of Paro town, near the end of the paved road. Drukgyal Dzong (victories fortress) was built around 1644-49 to commemorate the Bhutanese victory over the Tibetan-Mongol forces. It was later burnt in fire accident in 1951. On a clear day, Mt. Jumolhari, Bhutan's holy peak is seen against its backdrop.

Day 07: Paro

Early morning after early breakfast visit Tiger's Nest Monastery. After leisurely breakfast go for an excursion to Taktshang Monastery (5hrs hike): It is one of the most famous of Bhutan's monasteries, perched on the side of a cliff 900m above the Paro valley floor. It is said that Guru Rinpoche arrived here on the back of a tigress and meditated at this monastery and hence it is called 'Tiger's Nest'. This site has been recognized as a most sacred place and visited by Shabdrung Ngawang Namgyal in 1646 and now visited by all Bhutanese at least once in their lifetime. On 19 April, 1998, a fire severely damaged the main structure of building but now this Bhutanese jewel has been restored to its original splendour. P.M. walk down a hillside trail to visit Rinpung Dzong, which has a long and fascinating history. Built in 1646 by Shabdrung Ngawang Namgyal, the first spiritual and temporal ruler of Bhutan, the Dzong houses the monastic body of Paro, the office of the Dzongda (district administrative head) and Thrimpon (judge) of Paro district. The approach to the Dzong is through a traditional covered bridge called Nemi Zam. A walk through the bridge, over a stone inlaid path, offers a good view of the architectural wonder of the Dzong as well as life around it. It is also the venue of Paro Tshechu, held once a year in the spring.

Overnight at hotel.

Day 08: Paro – Connect flight to onward destination

After breakfast in time transfer to Paro Airport to connect departure flight.`,
    },
    {
      id: "bird-trek-bhutan",
      title: "Bird & Trek Tour of Bhutan",
      duration: "14 Days",
      type: "Birding",
      highlights: ["Birding", "Trekking", "Paro", "Thimphu", "Punakha", "Gangtey", "Bumthang", "Jele Dzong"],
      overview:
        "Combine birding and trekking in the Land of the Thunder Dragon. Trek from Paro to Thimphu via Jele Dzong, Jangchulakha, Jimilangtsho and Simkota; then explore Punakha, Wangduephodrang, Gangtey, Trongsa and Bumthang with dedicated birding. Ideal for nature lovers and bird watchers.",
      images: [
        "/Bhutan/Bhutan%20Birding1.jpg",
        "/Bhutan/bhutan%20birding.jpg",
        "/Bhutan/bhutan%20birdingg.jpg"
      ],
      details: `Bird & Trek Tour of Bhutan – Birding itinerary.

Day 01: Arrive Paro

In clear weather, Druk Air's flight to Bhutan provides a spectacular view of Himalayan scenery. Whether flying along the Himalayan range from Kathmandu or over the foothills from Kolkatta, it is a fascinating journey, culminating in an exciting descent past forested hills into the kingdom. Afternoon take an exploratory walk around Paro main street. Also visit Kyichu Lhakhang, one of the oldest and most sacred temple in the Kingdom, dating back to 7th century.

Overnight at the hotel in Paro.

Day 02: Paro

After breakfast drive to ruined fortress, the Drukgyal Dzong. Strategically built over the only passage into Paro valley, the Bhutanese repelled several invading Tibetan armies during the 17th century from this location. On a clear day, one can see the commanding view of Mount. Chomolhari from the village below the Dzong. Later embark on a fascinating excursion to Taktshang Monastery popularly known as Tiger's Nest. Perched on the side of a cliff 900m above Paro valley floor, it is Bhutan's most revered temple. The hike to the monastery makes a splendid half-day excursion. Evening visit Rinpung Dzong, meaning ("fortress of the heap of jewels"), which has a long and fascinating history. Along the wooden galleries lining the inner courtyard are fine wall paintings illustrating Buddhist lore such as four friends, the old man of long life, the wheel of life, scenes from the life of Milarepa, Mount. Sumeru and other cosmic Mandala.

Overnight at the hotel in Paro.

Day 03: Paro – Jele Dzong, 8km, 3 hours walk

Morning visit Ta Dzong, the National museum, holding fascinating collection of art, relics, religious thangkha paintings, handicrafts, masks, costumes, armour and Bhutan's exquisite postage stamps. The visit will provide an insight into the rich and unique cultural heritage and tradition of Bhutan. Then begin the trek. Today is a short trekking day. The journey starts with a short climb up to Jele Dzong. The trek trail ascends gradually up to the camp, and if the weather is clear Paro valley can be seen with snow-capped mountains behind. Above the camp is Jele-la pass (3,400m) and Jele Dzong (mostly in ruins). There is also a Lhakhang containing a statue of Buddha Sakyamuni.
...
Day 09: Thimphu / Punakha & Wangduephodrang (75 km, 2.1/2 hours)

From Thimphu, proceed further to Dochula pass (3,050m) which offers most spectacular view over high peaks of eastern Himalaya. From here the descent to Punakha and Wangduephodrang valley is long at the altitude difference between the pass and the valley is about 1,800 m. The route first passes through a temperate type of leafy forest where rhododendron and magnolia bloom in March and April then moves to semi tropical zone where, orange and banana tress and cactuses are found in abundance. Birds in Bhutan – More common species in these valleys are: Black-chinned Yuhina (Yuhina nigrimenta), Spotted Dove (Streptopelia chinensis), Black-chinned Babbler (Stachyris pyrrhops), Black-breasted Sunbird (Aethopyga saturata), Red-breasted Rosefinch (Carpodacus puniceus), Fulvous-breasted Pied Woodpecker (Picoides macei), Large Grey Babbler (Turdoides melcolmi), Himalaya Tree Pie (Dendrocitra vagabunda), Little Bunting (Emberiza striolata), Slaty-backed Forktail (Enicurus schistaceus), White-breasted Kingfisher (Halcyon smyrnensis), Yellow-billed Blue Magpie (Cissa flavirostris), Grey Heron (Ardea cinerea), Steppe Eagle (Aquila rapax nipalensis), Small Niltava (Muscicapa macgrigoriae), Himalayan Griffon (Gyps himalayensis), Speckled Wood Pigeon (Columbia hodgsonii), Grey Tit (Parus major) and Red-crowned Jay (Garrulus glandarius).

Day 10: Punakha & Wangduephodrang / Gangtey (70 km, 3 hours)
...
Day 11: Gangtey / Trongsa (130 km, 5 hours)

This stretch covers a range of habitat from tall, dense, evergreen forest characterized by moss and lichen, covered oak and rhododendron together with broad-leaved trees such as horse-chestnuts, laurels, maples and alders. At higher elevation, the composition changes perceptibly with conifers such as fir, spruce, larch, hemlock and juniper. Birds in Bhutan – Bamboo is another important habitat in this region, holding number of special but elusive species. It is not very prominent birding area but still few important species are visible such as: Himalayan Griffon (Gyps himalayensis), Himalayan Swiftlet (Collocalia brevirostris), Lammergeier (Gypaetus barbatus), Snow Partridge (Lerwa lerwa), Purple Cochoa (Cochoa purpurea), Scaly-breasted Wren Babbler (Pnoepyga albiventer), Long-tailed Minivet (Pericrocotus ethologus), Himalayan Monal Pheasant (Lophophorus impejanus), Speckled Wood Pigeon (Columba hodgsonii) and Rufous-bellied Bulbul (Hypsipetes mcclellandi).

Day 12: Trongsa / Bumthang (Jakar) (68 km, 3 hours)
...
After breakfast, drive to Thimphu en route visiting village houses and mingling with local people. Lunch break at Wangduephodrang which is known for its majestic Dzong and its bamboo products, slate and stone carvings. After lunch, drive to Thimphu for overnight stay.
