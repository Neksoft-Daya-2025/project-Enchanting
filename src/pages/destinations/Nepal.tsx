...
export default function Nepal() {
  const heroBannerImages = [
    "https://cdn.builder.io/api/v1/image/assets%2F1a7381da3c644900b059e8eec3b3323a%2Fe9edbae1a98d437c922e7cc6d199fa39?format=webp&width=2070",
    "/Himalayan peaks..png",
    "/kathamandu.jpg",
    "/Pokhra.jpeg",
    "/Royal Chitwan Nation Park.jpg",
    "/Fewa Lake.jpg",
  ];
  ...
  const destinations = [
    {
      ...
      description: "UNESCO World Heritage sites, ancient Hindu temples, Buddhist shrines, and the living heritage of Kathmandu Valley.",
      highlights: ["Kathmandu", "Bhaktapur", "Patan"],
      image: "/kathamandu.jpg",
      link: "/destinations/nepal/culture",
    },
    {
      title: "Wildlife & Nature",
      tagline: "Chitwan & Beyond",
      description: "Royal Chitwan National Park, one-horned rhinos, Bengal tigers, and diverse wildlife in pristine habitats.",
      highlights: ["Chitwan", "Tiger Safaris", "Elephant Safari"],
      image: "/Royal Chitwan Nation Park.jpg",
      link: "/destinations/nepal/wildlife",
    },
  ];
      ...
      <section className="relative min-h-[95vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="pointer-events-auto max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
            <p className="text-travel-gold-light tracking-[0.3em] uppercase text-sm font-medium mb-4">The Himalayan Kingdom</p>
            <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold text-white tracking-tight mb-6">
              ...
              <span className="block italic font-normal text-4xl sm:text-5xl md:text-6xl lg:text-7xl">The Himalayan Kingdom</span>
            </h1>
            <p className="text-lg sm:text-xl text-white/95 max-w-2xl mx-auto mb-10 leading-relaxed">
              From snow-capped Himalayan peaks to ancient temples and wildlife sanctuaries, Nepal offers diverse landscapes and rich cultural heritage.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              Situated along the Himalayan mountain range between Tibet and India, the country boasts some of the most diverse and exciting landscapes on the planet, from snow-capped mountains of Great Himalaya to low-lying wetlands which are home to a number of the earth's most endangered species - the Bengal Tiger and the Indian Rhino. Nepal's culture is just as varied, filled with centuries-old temples and shrines, a profusion of colorful festivals.
            </p>
          </div>
      ...
      <section className="py-20 md:py-28 bg-gradient-to-r from-travel-sky to-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-4xl md:text-5xl font-semibold text-travel-slate mb-6">
            Ready to Begin Your
            <span className="block italic font-normal">Himalayan Journey?</span>
          </h2>
          <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
            Let our expert travel planners create a personalized adventure across temples, wildlife, and mountain vistas.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Explore Nepal&apos;s iconic destinations featured in our tours.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-6 border-0 shadow-md bg-white rounded-xl">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-3">Everest Region</h3>
              <p className="text-gray-600 text-sm text-center mb-4">
                Home to Mount Everest and dramatic Himalayan vistas.
              </p>
              <p className="text-gray-500 text-xs text-center">
                • Trekking • Sherpa Culture • Mountain Flights
              </p>
            </Card>
            ...
            <Card className="p-6 border-0 shadow-md bg-white rounded-xl">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-3">Pokhara</h3>
              <p className="text-gray-600 text-sm text-center mb-4">
                Adventure capital with pristine lakes and stunning Annapurna views.
              </p>
              <p className="text-gray-500 text-xs text-center">
                • Phewa Lake • Paragliding • Mountain Views
              </p>
            </Card>
            ...
            <Card className="p-6 border-0 shadow-md bg-white rounded-xl">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-3">Chitwan</h3>
              <p className="text-gray-600 text-sm text-center mb-4">
                Royal National Park famous for Bengal tigers and one-horned rhinos.
              </p>
              <p className="text-gray-500 text-xs text-center">
                • Elephant Safari • Wildlife Spotting • Jungle Lodge
              </p>
            </Card>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Experience ancient Buddhist stupas, Hindu temples, and living heritage in Kathmandu Valley.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Swayambhunath and Boudhanath</div>
                <div>• Pashupatinath Temple rituals</div>
                <div>• Medieval squares of Bhaktapur and Patan</div>
              </div>
            </Card>
            ...
            <Card className="p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Trekking, mountain flights, and breathtaking alpine scenery throughout the Himalayas.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Everest and Annapurna regions</div>
                <div>• Scenic mountain flights</div>
                <div>• Lakeside leisure in Pokhara</div>
              </div>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Crystal-clear skies and pleasant temperatures. Ideal for trekking and sightseeing.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Temperature: 15-25°C</div>
                <div>• Best mountain visibility</div>
                <div>• Festivals and cultural events</div>
              </div>
            </Card>
            ...
            <Card className="p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Monsoon brings lush greenery and fewer crowds. Great for photography.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Vibrant landscapes</div>
                <div>• Some road closures possible</div>
            ...
            <Card className="p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Cooler temperatures with clear views. Best for cultural exploration in the valleys.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Crisp winter skies</div>
                <div>• Cold in higher altitudes</div>
                <div>• Great museum and heritage visits</div>
              </div>
            </Card>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <Card className="text-center p-6 border-0 shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                Visa on arrival available for many nationalities. Check latest regulations.
              </p>
            </Card>
            ...
            <Card className="text-center p-6 border-0 shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                7-12 days for highlights; 2+ weeks for trekking and culture.
              </p>
            </Card>
            ...
            <Card className="text-center p-6 border-0 shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                Domestic flights, private vehicles, and scenic mountain flights.
              </p>
            </Card>
