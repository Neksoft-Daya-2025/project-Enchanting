...
export default function SriLanka() {
  const heroBannerImages = [
    "/sri-lanka-1.webp",
    "/Srilanka/sri_lanka.jpg",
    "/Srilanka/sri lanka wildlife.jpg",
    "/Mirissa.jpg",
    "/sgiriya.jpg",
    "/Polonnaruwa.jpg",
  ];
  ...
  const destinations = [
    {
      ...
      description: "Explore 3000 years of history through ancient cities, UNESCO World Heritage sites, and the Temple of the Tooth Relic.",
      highlights: ["Sigiriya", "Anuradhapura", "Temple of the Tooth"],
      image: "/sgiriya.jpg",
      link: "/destinations/sri-lanka/culture",
    },
    {
      title: "Wildlife",
      tagline: "Nature's Treasure Chest",
      description: "Yala and Udawalawe National Parks, leopard safaris, elephant encounters, and diverse ecosystems.",
      highlights: ["Leopard Safaris", "Yala", "Elephant Encounters"],
      image: "/Srilanka/sri lanka wildlife.jpg",
      link: "/destinations/sri-lanka/wildlife",
    },
    {
      title: "Beaches & Islands",
      tagline: "Pearl of the Indian Ocean",
      description: "Pristine beaches, whale watching in Mirissa, and tropical coastal escapes along 1400 km of golden shores.",
      highlights: ["Whale Watching", "Mirissa", "Coastal Heritage"],
      image: "/Mirissa.jpg",
      link: "/destinations/sri-lanka/beaches",
    },
  ];
      ...
      <section className="relative min-h-[95vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="pointer-events-auto max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
            <p className="text-travel-gold-light tracking-[0.3em] uppercase text-sm font-medium mb-4">Pearl of the Indian Ocean</p>
            <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold text-white tracking-tight mb-6">
              ...
              <span className="block italic font-normal text-4xl sm:text-5xl md:text-6xl lg:text-7xl">Pearl of the Indian Ocean</span>
            </h1>
            <p className="text-lg sm:text-xl text-white/95 max-w-2xl mx-auto mb-10 leading-relaxed">
              Romantic landscapes, ancient civilizations, golden beaches, and 8 UNESCO World Heritage sites await in one of the world's most delightful destinations.
            </p>
      ...
      <section className="py-20 md:py-28 bg-gradient-to-r from-travel-sky to-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-4xl md:text-5xl font-semibold text-travel-slate mb-6">
            Ready to Begin Your
            <span className="block italic font-normal">Sri Lankan Journey?</span>
          </h2>
          <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
            Let our expert travel planners create a personalized adventure across tea plantations, ancient temples, and golden beaches.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Explore Sri Lanka&apos;s iconic destinations featured in our tours.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-6 border-0 shadow-md bg-white rounded-xl">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-3">Colombo</h3>
              <p className="text-gray-600 text-sm text-center mb-4">
                Modern capital with colonial architecture and vibrant markets.
              </p>
            ...
            <Card className="p-6 border-0 shadow-md bg-white rounded-xl">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-3">Yala National Park</h3>
              <p className="text-gray-600 text-sm text-center mb-4">
                Famous for leopards, elephants, and diverse wildlife.
              </p>
              <p className="text-gray-500 text-xs text-center">
            ...
            <Card className="p-6 border-0 shadow-md bg-white rounded-xl">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-3">Galle Fort</h3>
              <p className="text-gray-600 text-sm text-center mb-4">
                Historic Dutch fort with colonial architecture and ocean views.
              </p>
              <p className="text-gray-500 text-xs text-center">
                • Heritage • Architecture • Ocean Views
              </p>
            </Card>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Explore 3000 years of history through ancient cities, temples, and UNESCO World Heritage sites including Sigiriya Rock Fortress.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Anuradhapura and Polonnaruwa</div>
                <div>• Temple of the Tooth Relic</div>
            ...
            <Card className="p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Discover diverse ecosystems from national parks to pristine beaches and tea plantations. Yala, Udawalawe, and whale watching in Mirissa.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Yala and Udawalawe National Parks</div>
                <div>• Whale watching in Mirissa</div>
                <div>• Tea country in Nuwara Eliya</div>
              </div>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Dry season with perfect weather for beaches and cultural sites on west and south coasts.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Temperature: 25-30°C</div>
                <div>• Best for west and south coasts</div>
                <div>• Clear skies and calm seas</div>
              </div>
            </Card>
            ...
            <Card className="p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Monsoon season brings lush landscapes and fewer crowds. Best for east coast.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Lush green landscapes</div>
                <div>• Best for east coast</div>
            ...
            <Card className="p-8 border-0 shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Inter-monsoon period with mixed weather patterns. Good for cultural sites.
              </p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Variable weather conditions</div>
                <div>• Good for cultural sites</div>
                <div>• Moderate temperatures</div>
              </div>
            </Card>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <Card className="text-center p-6 border-0 shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                Electronic Travel Authorization (ETA) available online for most nationalities.
              </p>
            </Card>
            ...
            <Card className="text-center p-6 border-0 shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                10-14 days for comprehensive tour; 7 days for highlights.
              </p>
            </Card>
            ...
            <Card className="text-center p-6 border-0 shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                Private vehicles, domestic flights, and scenic train journeys.
              </p>
            </Card>
            ...
            <Card className="text-center p-6 border-0 shadow-lg">
              ...
              <p className="text-gray-600 text-sm">
                Drink bottled water, use mosquito repellent, and carry basic medications.
              </p>
            </Card>
          </div>
        </div>
